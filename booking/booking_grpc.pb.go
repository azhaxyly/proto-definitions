...
const (
	...
	BookingService_GetBookingStatus_FullMethodName = "/booking.BookingService/GetBookingStatus"
)
...
func (UnimplementedBookingServiceServer) GetBookingStatus(context.Context, *GetBookingStatusRequest) (*GetBookingStatusResponse, error) {
